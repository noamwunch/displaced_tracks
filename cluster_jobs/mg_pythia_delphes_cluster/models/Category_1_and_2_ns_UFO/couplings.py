...
GC_9 = Coupling(name = 'GC_9',
                value = 'complex(0,1)*lambdaXFdR1',
                order = {'QED':1})

GC_10 = Coupling(name = 'GC_10',
                 value = 'complex(0,1)*lambdaXFdR2',
                 order = {'QED':1})

GC_11 = Coupling(name = 'GC_11',
                 value = 'complex(0,1)*lambdaXFdR3',
                 order = {'QED':1})

GC_12 = Coupling(name = 'GC_12',
                 value = 'complex(0,1)*lambdaXFeR1',
                 order = {'QED':1})

GC_13 = Coupling(name = 'GC_13',
                 value = 'complex(0,1)*lambdaXFeR2',
                 order = {'QED':1})

GC_14 = Coupling(name = 'GC_14',
                 value = 'complex(0,1)*lambdaXFeR3',
                 order = {'QED':1})

GC_15 = Coupling(name = 'GC_15',
                 value = 'complex(0,1)*lambdaXFl1',
                 order = {'QED':1})

GC_16 = Coupling(name = 'GC_16',
                 value = 'complex(0,1)*lambdaXFl2',
                 order = {'QED':1})

GC_17 = Coupling(name = 'GC_17',
                 value = 'complex(0,1)*lambdaXFl3',
                 order = {'QED':1})

GC_18 = Coupling(name = 'GC_18',
                 value = 'complex(0,1)*lambdaXFq1',
                 order = {'QED':1})

GC_19 = Coupling(name = 'GC_19',
                 value = 'complex(0,1)*lambdaXFq2',
                 order = {'QED':1})

GC_20 = Coupling(name = 'GC_20',
                 value = 'complex(0,1)*lambdaXFq3',
                 order = {'QED':1})

GC_21 = Coupling(name = 'GC_21',
                 value = 'complex(0,1)*lambdaXFuR1',
                 order = {'QED':1})

GC_22 = Coupling(name = 'GC_22',
                 value = 'complex(0,1)*lambdaXFuR2',
                 order = {'QED':1})

GC_23 = Coupling(name = 'GC_23',
                 value = 'complex(0,1)*lambdaXFuR3',
                 order = {'QED':1})
