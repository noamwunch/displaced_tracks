...
//Main code
void RaveTest_cluster(const char *inputFile, double dRjetsMax, int label, int max_ev, const char *result) {
    ...
    factory.setDefaultMethod("avr-minweight:0.5-primcut:2-seccut:6"); // Default settings
