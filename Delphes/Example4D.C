...
//Main code
void Example4D(const char *inputFile, double dRjetsMax)
{
  //Prepare to write
  ofstream myfile;
  myfile.open ("Results1.txt");
   ...
   //MET
    ...
    if(p1Ass && p2Ass)
    {
      ...
      for(i = 0; i < branchTrack->GetEntriesFast(); ++i)
      {
        ...
        if(deltaR1 < dRjetsMax)
          myfile << entry << " " << "1 1 " << track->PT << " " << track->Eta << " " << track->Phi << " " << deltaR1 << " " << track->PID << " " << track->D0 << " " << track->DZ << " " << track->ErrorD0 <<  " " << track->ErrorDZ <<  " " << track->Xd << " " << track->Yd << endl;

        if(deltaR2 < dRjetsMax)
          myfile << entry << " " << "2 1 " << track->PT << " " << track->Eta << " " << track->Phi << " " << deltaR2 << " " << track->PID << " " << track->D0 << " " << track->DZ << " " << track->ErrorD0 << " " << track->ErrorDZ <<  " " << track->Xd << " " << track->Yd << endl;
      }
      ...
      for(i = 0; i < branchTower->GetEntriesFast(); ++i)
      {
        ...
        //Write information accordingly
        if(deltaR1 < dRjetsMax)
           myfile << entry << " " << "1 2 " << tower->ET << " " << tower->Eta << " " << tower->Phi << " " << deltaR1 << " " << 0 << " " << tower->Ehad << " " << tower->Eem << endl;

        if(deltaR2 < dRjetsMax)
          myfile << entry << " " << "2 2 " << tower->ET << " " << tower->Eta << " " << tower->Phi << " " << deltaR2 << " " << 0 << " " << tower->Ehad << " " << tower->Eem << endl;
      }
    }
    ...
    else
    {
      ...
      for(i = 0; i < branchTrack->GetEntriesFast(); ++i)
      {
        ...
        //Write information accordingly
        if(deltaR1 < dRjetsMax)
          myfile << entry << " " << "1 1 " << track->PT << " " << track->Eta << " " << track->Phi << " " << deltaR1 << " " << track->PID << " " << track->D0 << " " << track->DZ << " " << track->ErrorD0 <<  " " << track->ErrorDZ  <<  " " << track->Xd << " " << track->Yd << " " << track->Charge << endl;
        if(deltaR2 < dRjetsMax)
          myfile << entry << " " << "2 1 " << track->PT << " " << track->Eta << " " << track->Phi << " " << deltaR2 << " " << track->PID << " " << track->D0 << " " << track->DZ << " " << track->ErrorD0 <<  " " << track->ErrorDZ  <<  " " << track->Xd << " " << track->Yd << " " << track->Charge << endl;
      ...
      for(i = 0; i < branchTower->GetEntriesFast(); ++i)
      {
        ...
        if(deltaR2 < dRjetsMax)
          myfile << entry << " " << "2 2 " << tower->ET << " " << tower->Eta << " " << tower->Phi << " " << deltaR1 << " " << 0 << " " << tower->Ehad << " " << tower->Eem << endl;
      }
    }
  }
